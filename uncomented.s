...
<head>
    <title>Marco Aurélio Lima</title>
    <!-- Meta -->
    <meta charset="utf-8">
...
<body>
    ...
    <header class="header">
        <div class="container">                       
            <!--<img class="profile-image img-responsive pull-left" src="" alt="James Lee" />-->
            <div class="profile-content pull-left">
                <h1 class="name">Marco Aurélio Lima</h1>
                <h2 class="desc">Software Developer</h2>   
                <ul class="social list-inline">
                    <li><a href="http://twitter.com/marckdxbr"><i class="fa fa-twitter"></i></a></li>                   
                    <li><a href="http://facebook.com/marckdx"><i class="fa fa-facebook"></i></a></li>
                    <li><a href="http://linkedin.com/in/marckdx"><i class="fa fa-linkedin"></i></a></li>
                    <li><a href="http://github.com/marckdx"><i class="fa fa-github-alt"></i></a></li>                  
                    <li class="last-item"><a href="#"><i class="fa fa-hacker-news"></i></a></li>                 
                </ul> 
            </div><!--//profile-->
            <a class="btn btn-cta-primary pull-right" href="mailto:marckdx@outlook.com" target="_blank"><i class="fa fa-paper-plane"></i> Contact Me</a>              
        </div><!--//container-->
    </header><!--//header-->
            ...
            <div class="primary col-md-8 col-sm-12 col-xs-12">
                <section class="about section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <p>Before been a computer geek I'm a very curious people, so to me there's no problem to lerning something new, nowadays I'm focused in mobile development such as Android and Windows Desktop, web design is really not my forte.</p>    
                            <p>When I'm not programming or doing something related to I like to watche movies and series, also animes. Otherwise I will be studying something like physics, or hystory just to ot freak out. If you want to be my partner at Duolingo please contact me. =D</p>
               ...
               <!--<section class="latest section">
                ...
                <section class="projects section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <div class="item">
                                <h3 class="title"><a href="https://github.com/marckdx/advanced-notepad">Advanced Notepad</a></h3>
                                <p class="summary">A better replaceable software to Windows Notepad version with coding and encryption tools for free (Windows PC Only).</p>
                                <p><a class="more-link" href="https://github.com/marckdx/advanced-notepad" target="_blank"><i class="fa fa-external-link"></i> Find out more</a></p>
                            </div><!--//item-->
                             <div class="item">
                                <h3 class="title"><a href="https://github.com/marckdx/marckdx.api">Marckdx.Api</a></h3>
                                <p class="summary">An API with all the commmon classes and methods I use in my VS C# code available to .Net 3.5 and higher.</p>
                                <p><a class="more-link" href="https://github.com/marckdx/marckdx.api" target="_blank"><i class="fa fa-external-link"></i> Find out more</a></p>
                            </div><!--//item-->
                            
                            
                            <a class="btn btn-cta-secondary" href="#">More on Github <i class="fa fa-chevron-right"></i></a>
                ...
                <section class="experience section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            ...
                            <div class="item">
                                <h3 class="title">Software Developer - <span class="place"><a href="#">Praia Grande City Hall</a></span> <span class="year">(2015 - 2015)</span></h3>
                                <p>Develop sites using ASP.NET/ASP, make SQL Server procedures and testing software.</p>
                            </div><!--//item-->
                            
                            <div class="item">
                                <h3 class="title">Study Monitor - <span class="place"><a href="#">São Paulo State Technological College</a></span> <span class="year">(2014 - 2014)</span></h3>
                                <p>Help students to lern algorithms and data structure (C++)</p>
                            </div><!--//item-->
                ...
                <section class="github section">
                    <div class="section-inner">
                        ...
                        <div class="github-graph" id="github-graph">
                        </div>
            ...
            <div class="secondary col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><i class="fa fa-map-marker"></i><span class="sr-only">Location:</span>Santos, Brazil</li>
                                <li><i class="fa fa-envelope-o"></i><span class="sr-only">Email:</span><a href="mailto:marckdx@outlook.com">marckdx@outlook.com</a></li>
                                <li><i class="fa fa-link"></i><span class="sr-only">Website:</span><a href="http://megari.com.br">http://megari.com.br</a></li>
                            </ul>
                        </div><!--//content-->  
                    </div><!--//section-inner-->                 
                </aside><!--//aside-->
                ...
                <aside class="skills aside section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <p class="intro">
                                Backend software developer specialized in C#, TFS and Unit Test.</p>
                            
                            <div class="skillset">
                               
                                <div class="item">
                                    <h3 class="level-title">Visual C# & Unit Test<span class="level-label" data-toggle="tooltip" data-placement="left" data-animation="true" title="You can use the tooltip to add more info...">Expert</span></h3>
                                    <div class="level-bar">
                                ...
                                <div class="item">
                                    ...
                                    <div class="level-bar">
                                        <div class="level-bar-inner" data-level="64%">
                                        </div>                                      
                                    </div><!--//level-bar-->                                 
                                </div><!--//item-->
                                
                                <div class="item">
                                    <h3 class="level-title">PHP<span class="level-label">Expert</span></h3>
                                    <div class="level-bar">
                                ...
                                <div class="item">
                                    <h3 class="level-title">Zend<span class="level-label">Pro</span></h3>
                                    <div class="level-bar">
                                ...
                                <p><a class="more-link" href="https://coderwall.com/marckdx"><i class="fa fa-external-link"></i> More on Coderwall</a></p> 
                            </div>              
                        </div>
                    </div>                
                </aside>
                ...
                <aside class="education aside section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <div class="item">                      
                                <h3 class="title"><i class="fa fa-graduation-cap"></i>International Trade</h3>
                                <h4 class="university">São Paulo State Technological College <span class="year">(2015-2018)</span></h4>
                            </div><!--//item-->
                            <div class="item">
                                <h3 class="title"><i class="fa fa-graduation-cap"></i>System Analysis</h3>
                                <h4 class="university">São Paulo State Technological College<span class="year">(2012-2015)</span></h4>
                            </div><!--//item-->
                        </div><!--//content-->
                    </div><!--//section-inner-->
                </aside><!--//section-->
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                ...
                                <li class="item">
                                    ...
                                    <span class="level">Professional Proficiency <br class="visible-sm visible-xs"/><i class="fa fa-star"></i> <i class="fa fa-star"></i>  <i class="fa fa-star-half"></i></span>
                                </li><!--//item-->
                                 <li class="item">
                                    <span class="title"><strong>Spanish:</strong></span>
                                    <span class="level">Professional Proficiency <br class="visible-sm visible-xs"/><i class="fa fa-star"></i></i> <i class="fa fa-star-half"></i></span>
                                </li><!--//item-->
                            </ul>
                        </div><!--//content-->
                    </div><!--//section-inner-->
    ...
    <script>
        GitHubCalendar(".calendar", "marckdx");
    </script>         
</body>
</html> 
